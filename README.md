...
<div align="left">
    <p>
        test-lang is the TOOL-tier crate: A snapshot harness: given source, assert the token stream / AST / diagnostics. Part of the -lang language-construction family; see _strategy/LANG_COLLECTION.md for the master plan.
    </p>
    <br>
    <hr>
    <p>
